...
![Version](https://img.shields.io/badge/version-29.1.3-blue.svg)
...
### Latest Release: v29.1.3

Download from [GitHub Releases](https://github.com/Fixed-Blockchain/fixedcoin/releases/tag/v29.1.3)

#### Windows

**Setup Installer (Recommended)**
- [fixedcoin-29.1.3-win64-setup.exe](https://github.com/Fixed-Blockchain/fixedcoin/releases/download/v29.1.3/fixedcoin-29.1.3-win64-setup.exe)

**Portable Archive**
- [fixedcoin-29.1.3-win64.zip](https://github.com/Fixed-Blockchain/fixedcoin/releases/download/v29.1.3/fixedcoin-29.1.3-win64.zip)

#### macOS

**Disk Image (Recommended)**
- [fixedcoin-29.1.3-x86_64-apple-darwin.dmg](https://github.com/Fixed-Blockchain/fixedcoin/releases/download/v29.1.3/fixedcoin-29.1.3-x86_64-apple-darwin-dmg.zip)

**Archive (Intel)**
- [fixedcoin-29.1.3-x86_64-apple-darwin.tar.gz](https://github.com/Fixed-Blockchain/fixedcoin/releases/download/v29.1.3/fixedcoin-29.1.3-x86_64-apple-darwin-tar.zip)

#### Linux

**x86_64 (64-bit Intel/AMD)**
- [fixedcoin-29.1.3-x86_64-linux-gnu.tar.gz](https://github.com/Fixed-Blockchain/fixedcoin/releases/download/v29.1.3/fixedcoin-29.1.3-x86_64-linux-gnu.tar.gz)

**ARM64 (Raspberry Pi, ARM servers)**
- [fixedcoin-29.1.3-aarch64-linux-gnu.tar.gz](https://github.com/Fixed-Blockchain/fixedcoin/releases/download/v29.1.3/fixedcoin-29.1.3-aarch64-linux-gnu.tar.gz)
...
1. Download [fixedcoin-29.1.3-win64-setup.exe](https://github.com/Fixed-Blockchain/fixedcoin/releases/download/v29.1.3/fixedcoin-29.1.3-win64-setup.exe)
2. Run the installer and follow the setup wizard
3. Launch FixedCoin from Start Menu
4. Wait for blockchain synchronization

**Using Portable Archive:**
1. Download [fixedcoin-29.1.3-win64.zip](https://github.com/Fixed-Blockchain/fixedcoin/releases/download/v29.1.3/fixedcoin-29.1.3-win64.zip)
...
1. Download [fixedcoin-29.1.3-x86_64-apple-darwin.dmg](https://github.com/Fixed-Blockchain/fixedcoin/releases/download/v29.1.3/fixedcoin-29.1.3-x86_64-apple-darwin-dmg.zip)
2. Open the DMG file
...
```bash
# Download
curl -L -O https://github.com/Fixed-Blockchain/fixedcoin/releases/download/v29.1.3/fixedcoin-29.1.3-x86_64-apple-darwin-tar.zip

# Extract
tar -xzf fixedcoin-29.1.3-x86_64-apple-darwin.tar.gz

# Make binaries executable
chmod +x fixedcoin-29.1.3/bin/*

# Run GUI wallet
./fixedcoin-29.1.3/bin/fixedcoin-qt

# Or run daemon in background
./fixedcoin-29.1.3/bin/fixedcoind -daemon
```
...
```bash
# Download
wget https://github.com/Fixed-Blockchain/fixedcoin/releases/download/v29.1.3/fixedcoin-29.1.3-x86_64-linux-gnu.tar.gz

# Extract
tar -xzf fixedcoin-29.1.3-x86_64-linux-gnu.tar.gz
...
```bash
# Download
wget https://github.com/Fixed-Blockchain/fixedcoin/releases/download/v29.1.3/fixedcoin-29.1.3-aarch64-linux-gnu.tar.gz

# Extract
tar -xzf fixedcoin-29.1.3-aarch64-linux-gnu.tar.gz
...
mv fixedcoin-29.1.3/bin/* /var/fixedcoin/bin/
...
Clean up:
```bash
rm -rf fixedcoin-29.1.3 fixedcoin-29.1.3-*.tar.gz
```
...
FixedCoin uses a DNS seeder for automatic peer discovery. New nodes query `dnsseed.fixedcoin.org` to find active peers on the network.

- **Seeder source:** [github.com/biigbang0001/seeder-fixedcoin](https://github.com/biigbang0001/seeder-fixedcoin)

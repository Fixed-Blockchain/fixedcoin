...
// Copyright (c) 2009-2020 The FixedCoin Core developers
...
#ifndef FIXEDCOIN_COMMON_MESSAGES_H
#define FIXEDCOIN_COMMON_MESSAGES_H
...
#endif // FIXEDCOIN_COMMON_MESSAGES_H

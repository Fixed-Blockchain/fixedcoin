// Copyright (c) 2019-2020 The FixedCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef FIXEDCOIN_SCRIPT_KEYORIGIN_H
#define FIXEDCOIN_SCRIPT_KEYORIGIN_H
...
#endif // FIXEDCOIN_SCRIPT_KEYORIGIN_H

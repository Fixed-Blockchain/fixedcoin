    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (about)
    {
        ...
        QString header = "The fixedcoin-qt application provides a graphical interface for interacting with " CLIENT_NAME ".\n\n"
                         "It combines the core functionalities of fixedcoind with a user-friendly interface for wallet management, transaction history, and network statistics.\n\n"
                         ...
                         "Usage: fixedcoin-qt [options] [URI]\n\n";

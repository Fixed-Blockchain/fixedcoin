      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->fixedcoinAtStartup->setToolTip(ui->fixedcoinAtStartup->toolTip().arg(CLIENT_NAME));
    ui->fixedcoinAtStartup->setText(ui->fixedcoinAtStartup->text().arg(CLIENT_NAME));

    ui->openFixedCoinConfButton->setToolTip(ui->openFixedCoinConfButton->toolTip().arg(CLIENT_NAME));

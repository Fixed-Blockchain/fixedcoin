...
#include <algorithm>
#include <attributes.h> // Added for FixedCoin Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for FixedCoin Core
#include <util/string.h> // Added for FixedCoin Core
...
// Added for FixedCoin Core. Similar to std::runtime_format from C++26.
...
// Added for FixedCoin Core. Wrapper for checking format strings at compile time.

...
#ifndef FIXEDCOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
#define FIXEDCOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
...
#endif // FIXEDCOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H

...
#ifndef FIXEDCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define FIXEDCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // FIXEDCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H

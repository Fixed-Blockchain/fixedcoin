// Copyright (c) 2011-present The FixedCoin Core developers
...
constexpr inline auto TEST_DIR_PATH_ELEMENT{"test_common fixedcoin"}; // Includes a space to catch possible path escape issues.

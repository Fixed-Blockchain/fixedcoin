...
We aim to cut a regular release every 3-4 months, approximately twice as frequent as major FixedCoin Core releases. Every second release should be published one month before the feature freeze of the next major FixedCoin Core release, allowing sufficient time to update the library in Core.
...
6. Send an announcement email to the fixedcoin-dev mailing list.
...
7. Send an announcement email to the fixedcoin-dev mailing list.

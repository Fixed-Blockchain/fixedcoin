// Copyright (c) The FixedCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef FIXEDCOIN_CLUSTER_LINEARIZE_H
#define FIXEDCOIN_CLUSTER_LINEARIZE_H
...
public:
     ...
     *
     * See https://delvingfixedcoin.org/t/introduction-to-cluster-linearization/1032 for background.
     */
    ...
    std::pair<SetInfo<SetType>, uint64_t> FindCandidateSet(uint64_t max_iterations, SetInfo<SetType> best) noexcept
    {
        ...
        auto add_fn = [&](SetInfo<SetType> inc, SetType und) noexcept {
            ...
            if (!inc.feerate.IsEmpty()) {
                ...
                //
                // See https://delvingfixedcoin.org/t/how-to-linearize-your-cluster/303 section 2.4.
...
#endif // FIXEDCOIN_CLUSTER_LINEARIZE_H

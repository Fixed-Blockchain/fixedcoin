...
#ifndef FIXEDCOIN_IPC_CAPNP_COMMON_TYPES_H
#define FIXEDCOIN_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between fixedcoin processes.
...
//! Functions to serialize / deserialize common fixedcoin types.
namespace mp {
...
#endif // FIXEDCOIN_IPC_CAPNP_COMMON_TYPES_H

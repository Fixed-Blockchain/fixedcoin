...
Bitcoin Core version 23.0 is now available from:
  ...
  <https://fixedcoin.org/bin/bitcoin-core-23.0/>
...
- Full support has been added for the CJDNS network. See the new option `-cjdnsreachable` and [doc/cjdns.md](https://github.com/Fixed-Blockchain/fixedcoin/tree/23.x/doc/cjdns.md) (#23077)
...
[doc/tracing.md](https://github.com/Fixed-Blockchain/fixedcoin/blob/23.x/doc/tracing.md) and
usage examples are provided in [contrib/tracing/](https://github.com/Fixed-Blockchain/fixedcoin/tree/23.x/contrib/tracing).

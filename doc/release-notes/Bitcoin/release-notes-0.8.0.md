FixedCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/fixedcoin/files/FixedCoin/fixedcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the FixedCoin
...
New/changed settings (command-line or fixedcoin.conf file)
--------------------------------------------------------

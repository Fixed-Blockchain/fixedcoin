FixedCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/fixedcoin/files/FixedCoin/fixedcoin-0.5.4/
...
http://gitorious.org/fixedcoin/fixedcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix FixedCoin-Qt notifications under Growl 1.3.
Increase required age of FixedCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxFixedCoin properly when installing FixedCoin-Qt over it. (Windows)

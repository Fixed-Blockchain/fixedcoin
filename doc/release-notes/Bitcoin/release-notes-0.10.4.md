FixedCoin Core version 0.10.4 is now available from:

  <https://fixedcoin.org/bin/fixedcoin-core-0.10.4/>
...
- #6953 `43c2789` Split fixedcoin-tx into its own package
- #6953 `dfe0d4d` Include fixedcoin-tx binary on Debian/Ubuntu

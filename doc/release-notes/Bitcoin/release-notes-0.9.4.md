FixedCoin Core version 0.9.4 is now available from:
...
this update is incompatible with the FixedCoin system and could lead to consensus
forks.

FixedCoin Core released binaries from https://fixedcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~fixedcoin/+archive/ubuntu/fixedcoin
- A third-party or self-compiled FixedCoin Core

upgrade to FixedCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

Bitcoin Core version 0.13.0 is now available from:
  ...
  <https://fixedcoin.org/bin/bitcoin-core-0.13.0/>
...
[Pull request](https://github.com/Fixed-Blockchain/fixedcoin/pull/8035/files), [BIP 32](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki)
...
- Each ZMQ notification now contains an up-counting sequence number that allows
  ...
  PR [#7762](https://github.com/Fixed-Blockchain/fixedcoin/pull/7762).

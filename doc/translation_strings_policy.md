...
This document provides guidelines for internationalization of the FixedCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `fixedcoin_en.ts` remains unchanged.

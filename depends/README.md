...
**When configuring FixedCoin Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring FixedCoin Core:
...
variables will be set when generating the FixedCoin Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.

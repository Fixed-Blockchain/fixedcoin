...
signature file SHA256SUMS.asc from fixedcoin.org and fixedcoin.org and
compares them.
...
def verify_published_handler(args: argparse.Namespace) -> ReturnCode:
    ...
    # remove binaries that are known not to be hosted by fixedcoin.org
...
def main():
    ...
    pub_parser.add_argument(
        ...
        help=(
            ...
            '(Sometimes fixedcoin.org lags behind fixedcoin.org.)')
    )
